...
import com.wyymusic.main.model.MusicData;
import com.wyymusic.main.service.MusicService;
import com.wyymusic.main.util.DisplayUtil;
import com.wyymusic.main.util.FastBlurUtil;
import com.wyymusic.main.widget.BackgourndAnimationRelativeLayout;
import com.wyymusic.main.widget.DiscView;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import static com.wyymusic.main.widget.DiscView.DURATION_NEEDLE_ANIAMTOR;


public class MusicActivity extends AppCompatActivity implements DiscView.IPlayInfo, View
        .OnClickListener {
    ...
    private void initMusicDatas() {
        MusicData musicData = new MusicData(R.raw.xiangyu1, R.raw.xiangyu, songName, singerName);
